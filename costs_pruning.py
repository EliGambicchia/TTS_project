...
#
# average_join_cost(filename="./target_join_pruning/baseline_pruning06.txt")
# average_target_cost(filename="./target_join_pruning/baseline_pruning06.txt")
#
# average_join_cost(filename="./target_join_pruning/baseline_pruning025.txt")
# average_target_cost(filename="./target_join_pruning/baseline_pruning025.txt")
#
# average_join_cost(filename="./target_join_pruning/baseline_pruning001.txt")
# average_target_cost(filename="./target_join_pruning/baseline_pruning001.txt")
...
#
# average_join_cost(filename="./target_join_pruning/baseline_beam_pruning06.txt")
# average_target_cost(filename="./target_join_pruning/baseline_beam_pruning06.txt")
#
# average_join_cost(filename="./target_join_pruning/baseline_beam_pruning025.txt")
# average_target_cost(filename="./target_join_pruning/baseline_beam_pruning025.txt")
#
# average_join_cost(filename="./target_join_pruning/baseline_beam_pruning02.txt")
# average_target_cost(filename="./target_join_pruning/baseline_beam_pruning02.txt")
#
# average_join_cost(filename="./target_join_pruning/baseline_beam_pruning015.txt")
# average_target_cost(filename="./target_join_pruning/baseline_beam_pruning015.txt")
#
# average_join_cost(filename="./target_join_pruning/baseline_beam_pruning01.txt")
# average_target_cost(filename="./target_join_pruning/baseline_beam_pruning01.txt")
#
# average_join_cost(filename="./target_join_pruning/baseline_beam_pruning001.txt")
# average_target_cost(filename="./target_join_pruning/baseline_beam_pruning001.txt")

# # FRICATIVES VS LIQUIDS
# print("fricatives")
# average_join_cost(filename="./voices/sea_shells.txt")
#
# print("liquids")
# average_join_cost(filename="./voices/willie.txt")